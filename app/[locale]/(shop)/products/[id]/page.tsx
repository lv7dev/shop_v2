    ...
    <div className="mx-auto max-w-7xl px-4 py-8">
          ...
          {product.reviews && product.reviews.length > 0 && (
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-muted-foreground">
                {t("product.reviewCount", { rating: avgRating.toFixed(1), count: product.reviews.length })}
              </span>
            </div>
          )}
              ...
              <div className="flex-1">
                <p className="text-sm font-semibold text-green-700 dark:text-green-400">
                  {activeDiscount.type === "PERCENTAGE"
                    ...
                    : formatPrice(Number(activeDiscount.value), locale)}{" "}
                  {t("product.off")} {t("product.withCode")}{" "}
      ...
      {product.reviews && product.reviews.length > 0 && (
        <section className="mt-16">
          <h2 className="mb-6 text-2xl font-bold">{t("product.customerReviews")}</h2>
