    ...
    <div>
      ...
      <div className="mt-8 grid gap-4 lg:grid-cols-2">
        <div className="rounded-lg border p-6">
          <div className="mb-4 flex items-center gap-2">
            ...
            <h2 className="text-lg font-semibold">{t("dashboard.revenueLast30")}</h2>
          </div>
        ...
        <div className="rounded-lg border p-6">
          <div className="mb-4 flex items-center gap-2">
            ...
            <h2 className="text-lg font-semibold">{t("dashboard.ordersPerDay")}</h2>
          </div>
      ...
      <div className="mt-4 rounded-lg border p-6">
        <div className="mb-4 flex items-center gap-2">
          ...
          <h2 className="text-lg font-semibold">{t("dashboard.topSelling")}</h2>
        </div>
          ...
          <div className="border-b border-orange-200 px-6 py-4 dark:border-orange-900/50">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-lg font-semibold">{t("dashboard.lowStockAlerts")}</h2>
            ...
            {allLowStockItems.map((item) => (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    {item.stock === 0 ? t("dashboard.outOfStock") : t("dashboard.itemsLeft", { count: item.stock })}
                  </Badge>
                </div>
              </Link>
            ))}
              ...
              >
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    {t("dashboard.itemCount", { count: order._count.items })}
                  </p>
                </div>
